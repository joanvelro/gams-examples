...
Set
   t 'scheduling periods (2hrs)' / period-1*period-6 /
   u 'generating units'          / oil, others /;

Parameter
   load(t)    'system load' / period-1 400, period-2 900, period-3 700, period-4 500, period-5 560, period-6 870/
...
** obj: 18534.2 (16952 iterations performed in 0 seconds)
*option minlp=LOCALSOLVER;

** obj: 18534.16 (142 iterations (0.42 seconds)) 
*option minlp=BONMIN;

** obj: 18534.160376 (3 iterations 0.03 seconds) 
*option minlp=DICOPT;

** obj: 18532.3071451 (1 iteration 0.18 seconds) it used local search
*option minlp=BARON;

** obj: 18534.1603757862 (4 iterations 0.026 seconds)
*option minlp=KNITRO;

** obj: 19302.527  (31 iterations 1.259s)
*option minlp=XPRESS;

** obj: 18534.1603757911e (0.29s)
*option minlp=SCIP;
