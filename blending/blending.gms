...
Parameter
    ...
    sulfuro_c(C)  'Sulfuro componentes'             / C1 0.57, C2 0.37, C3 0.45 /
    sulfuro_s(T)  'Sulfuro stock'                   / T1 0.35, T2 0.54, T3 0.48 /
...
Variable
    z             'Variable objetivo coste total';
...
total_cost..                z =e= sum(C, Qc(C)*Price_c(C)) + sum(T, Qs(T)*Price_s(T)) ;
